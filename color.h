...
#define TCS3472_EMPTY {0, IIC1, 0, x1}
...
extern tcs3472 color_init(int integration_time_ms, const io_t pin_scl, const io_t pin_sda);

extern tcsReading color_read(tcs3472 sensor, int integration_time_ms);
#endif // _TCSLIB_H_
