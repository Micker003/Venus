    ...
    */
    ...
    int useSensors() {
        ...
        int prop = returnSquareProperty(s);
        return prop; 
    }
    ...
    */
    int checkSquare() {
        ...
        //case only applies for when sensorProp == 0 i.e. the coordinate is empty
    ...
    */
    ...
    /**
    * translates the struct squareType into a simple int that can be stored in coordinates
    */
    ...
    */
    ...
    void exploreForward(struct coordinates cc, struct Queue* queue) {
        ...
        */
        ...
        propertyAtCoordinate = checkSquare();
